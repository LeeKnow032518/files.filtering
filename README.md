...
После клонирования проекта, зайти в папку проекта и ввести команду
<pre>
  <code>mvn clean package</code>
</pre>

В папке <code>/target</code> появится jar файл для запуска приложения, в папку перенести входные файлы.
<pre>
  <code>cd target</code>
</pre>
